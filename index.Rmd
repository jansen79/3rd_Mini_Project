...
### Chart 1 - Number of Wells Fargo Complaints by State
...
tentable <-table(top_ten_complaint_companies$company)
tentable
...
fivetable <-table(top_five_complaints_for_each_companies$company, top_five_complaints_for_each_companies$product)
fivetable
